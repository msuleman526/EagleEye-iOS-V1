...
internal enum L10n {
  ...
  /// 删除失败
  internal static let deleteFail = L10n.tr("Localizable", "Delete Fail")
  /// 删除成功
  internal static let deleteSuccess = L10n.tr("Localizable", "Delete Success")
  /// 删除中...
  ...
  /// 开始下载并播放
  internal static let downloadAndPlay = L10n.tr("Localizable", "Download And Play")
  /// 开始下载并分享
  internal static let downloadAndShare = L10n.tr("Localizable", "Download And Share")
  /// 下载失败
  internal static let downloadFail = L10n.tr("Localizable", "Download Fail")
  /// 下载中...
  internal static let downloading = L10n.tr("Localizable", "Downloading")
  /// 下载成功
  internal static let downloadSuccess = L10n.tr("Localizable", "Download Success")
  /// 时长
  internal static let duration = L10n.tr("Localizable", "Duration")
  /// 格式
  internal static let format = L10n.tr("Localizable", "Format")
  /// 加载失败，请检查飞机的连接状态。
  internal static let loadingFail = L10n.tr("Localizable", "Loading Fail, Not Connected Yet")
  /// 正在加载图片列表...
  internal static let loadingList = L10n.tr("Localizable", "Loading List")
  /// 加载超时，请稍后再试。
  internal static let loadingTimeout = L10n.tr("Localizable", "Loading Timeout,")
  /// 没有媒体文件
  internal static let noMediaFiles = L10n.tr("Localizable", "No Media Files Available")
  /// 提示
